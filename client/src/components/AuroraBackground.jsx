...
function toColorArray(colorStops) {
...
export default function AuroraBackground({
  colorStops = ["#0f766e", "#f59e0b", "#4f46e5"],
  speed = 0.42,
  amplitude = 1.35,
  blend = 0.58
}) {
  ...
  useEffect(() => {
    ...
    function update(time) {
      ...
      program.uniforms.uColorStops.value = toColorArray(propsRef.current.colorStops);
  ...
  return (
    <div className="aurora-shell" ref={containerRef} aria-hidden="true">
